    ...
    <ul class="sidebar-menu">
      <li>
        <router-link
          ...
          class="menu-item"
        >
          <span class="menu-label">报表设计器</span>
        </router-link>
      </li>

      <li>
        <router-link to="/jimu-bi" active-class="sub-active" class="sub-item">
          <span class="menu-label">仪表盘设计器</span>
        </router-link>
      </li>
      <li>
        <router-link to="/go-view" active-class="sub-active" class="sub-item">
          <span class="menu-label">大屏设计器</span>
        </router-link>
      </li>
