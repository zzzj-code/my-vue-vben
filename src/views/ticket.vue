    ...
    <ul class="sidebar-menu">
      <li>
        <router-link
          ...
          class="menu-item"
        >
          <span class="menu-label">工单列表</span>
        </router-link>
      </li>

      <li>
        <router-link to="/ticket-pool" active-class="sub-active" class="sub-item">
          <span class="menu-label">工单池</span>
        </router-link>
      </li>
      <li>
        <router-link to="/handler-group" active-class="sub-active" class="sub-item">
          <span class="menu-label">处理组管理</span>
        </router-link>
      </li>
      <li>
        <router-link to="/sla-rule" active-class="sub-active" class="sub-item">
          <span class="menu-label">SLA规则</span>
        </router-link>
      </li>
