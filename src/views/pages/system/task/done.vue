        ...
        <form @submit.prevent="handleSearch">
          <div class="top-tab">
            <div class="top-row">
              <div class="tab-a">
                <span>系统分类</span>
                <input type="text" placeholder="请输入系统分类" v-model="searchForm.type" />
              </div>
              <div class="tab-a">
                <span>单据类型</span>
            ...
            <div class="top-row">
              ...
              <div class="tab-a">
                <span>发起时间</span>
                <input type="text" placeholder="请选择申请部门" v-model="searchForm.createTime" />
              </div>
              <div class="tab-b">
...
export default {
  ...
  methods: {
    ...
    async loadDoneList() {
      try {
        ...
        this.rows = data.list.map((item) => ({
          ...
          number: item.processInstance?.billCode || "",
    ...
    // 重置
    handleReset() {
      this.searchForm = { type: "", billCode: "", createTime: "" };
      this.pagination.pageNo = 1;
      this.loadDoneList();
    },
    // 分页
