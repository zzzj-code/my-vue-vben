  ...
  <div class="page-wrapper">
    <div class="app">
      <div class="app-top">
        ...
        <div>
          <span>薪酬主体</span>
          <input type="text" placeholder="请输入薪酬主体" />
        </div>
        <div>
          <span>薪酬方案</span>
          <input type="text" placeholder="请输入薪酬方案" />
        </div>
        <div>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th>创建时间</th>
                <th class="oc-col" style="width: 180px">操作</th>
              </tr>
            </thead>
            <tbody>
    ...
    return {
      tabValue: [
        ...
        },
        {
          ...
          planName: "高管绩效薪酬方案",
          subject: "宇擎科技集团",
          personnelStatus: "高管人员",
          settlementCycle: "季度",
          payDay: "每季度末月25日",
          currency: "人民币(CNY)",
          completeness: "100%",
          status: "已启用",
          createTime: "2026-03-01 11:30:00",
        },
        {
          id: 6,
          planName: "销售提成薪酬方案",
          subject: "宇擎成都分公司",
          personnelStatus: "销售岗位",
          settlementCycle: "月度",
          payDay: "每月18日",
          currency: "人民币(CNY)",
          completeness: "90%",
          status: "已启用",
          createTime: "2026-03-15 09:45:00",
        },
        {
          id: 7,
          planName: "财务人员薪酬方案",
        ...
        },
        {
          ...
          planName: "兼职人员薪酬方案",
          subject: "宇擎武汉分公司",
          personnelStatus: "兼职人员",
          settlementCycle: "周度",
          payDay: "每周五",
          currency: "人民币(CNY)",
          completeness: "70%",
          status: "配置中",
          createTime: "2026-04-15 13:20:00",
        },
        {
          id: 9,
          planName: "项目制薪酬方案",
          subject: "宇擎南京分公司",
          personnelStatus: "项目人员",
          settlementCycle: "项目结算",
          payDay: "项目验收后5日",
          currency: "人民币(CNY)",
          completeness: "85%",
          status: "已停用",
