  ...
  <div class="page-wrapper">
    <div class="app">
      <div class="app-top">
        ...
        <div>
          <span>薪资批次</span>
          <input type="text" placeholder="请输入薪资批次" />
        </div>
        <div>
          <span>单据状态</span>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th>创建人</th>
                <th>创建时间</th>
                <th class="oc-col" style="width: 80px">操作</th>
              </tr>
            </thead>
            <tbody>
  ...
  data() {
    return {
      tabValue: [
        {
          id: 1,
          documentNo: 'SALARY-2026-001',
          documentStatus: '待审批',
          batchNo: 'BATCH-2026-001',
          batchName: '2026年1月薪资批次',
          subject: '宇擎科技集团',
          year: '2026',
          month: '1',
          peopleCount: 156,
          totalNetPay: '1,539,739.50',
          creator: '张经理',
          createTime: '2026-01-25 14:30:00'
        },
        {
          id: 2,
          documentNo: 'SALARY-2026-002',
          documentStatus: '已审批',
          batchNo: 'BATCH-2026-002',
          batchName: '2026年2月薪资批次',
          subject: '宇擎深圳分公司',
          year: '2026',
          month: '2',
          peopleCount: 89,
          totalNetPay: '1,027,343.70',
          creator: '李主管',
          createTime: '2026-02-24 16:20:00'
        },
        {
          id: 3,
          documentNo: 'SALARY-2026-003',
          documentStatus: '已审批',
          batchNo: 'BATCH-2026-003',
          batchName: '2026年3月薪资批次',
          subject: '宇擎上海分公司',
          year: '2026',
          month: '3',
          peopleCount: 67,
          totalNetPay: '823,710.80',
          creator: '王经理',
          createTime: '2026-03-25 10:15:00'
        },
        {
          id: 4,
          documentNo: 'SALARY-2026-004',
          documentStatus: '待审批',
          batchNo: 'BATCH-2026-004',
          batchName: '2026年4月薪资批次',
          subject: '宇擎北京研发中心',
          year: '2026',
          month: '4',
          peopleCount: 45,
          totalNetPay: '623,743.20',
          creator: '刘主管',
          createTime: '2026-04-24 11:40:00'
        },
        {
          id: 5,
          documentNo: 'SALARY-2026-005',
          documentStatus: '已驳回',
          batchNo: 'BATCH-2026-005',
          batchName: '2026年5月薪资批次',
          subject: '宇擎成都分公司',
          year: '2026',
          month: '5',
          peopleCount: 78,
          totalNetPay: '845,365.50',
          creator: '陈经理',
