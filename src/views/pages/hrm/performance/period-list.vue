  ...
  <div class="page-wrapper">
    <div class="app">
      <div class="app-top">
        <div>
          <span>批次编码</span>
          <input type="text" placeholder="请输入批次编码" />
        </div>
        <div>
          <span>批次名称</span>
          <input type="text" placeholder="请输入批次名称" />
        </div>
        <div>
          <span>批次类型</span>
          <input type="text" placeholder="请输入批次类型" />
        </div>
        <div>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th>状态</th>
                <th>创建时间</th>
                <th class="oc-col" style="width: 560px">操作</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(item, index) in tabValue" :key="item.id">
                ...
                <td class="oc-col">编辑  发布  生成目标确认单  查看目标确认单  查看结果  批次结果审批  归档  删除</td>
              </tr>
            </tbody>
          </table>
        </div>
...
.main-title div:nth-child(2) button:nth-child(2){
