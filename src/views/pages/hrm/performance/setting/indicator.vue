  ...
  <div class="page-wrapper">
    <div class="app">
      <div class="app-top">
        <div>
          <span>指标编码</span>
          <input type="text" placeholder="请输入指标编码" />
        </div>
        <div>
          <span>指标名称</span>
        ...
        <div>
          <span>指标类型</span>
          <input type="text" placeholder="请输入指标类型" />
        </div>
        <div>
          ...
          <table>
            ...
            <tbody>
              <tr v-for="(item, index) in tabValue" :key="item.id">
                ...
                <td>{{ item.evalMode }}</td>
                <td>{{ item.scoreMode }}</td>
                <td>{{ item.salaryLink }}</td>
                <td>{{ item.status }}</td>
  ...
  data() {
    return {
      tabValue: [
        {
          id: 1,
          planName: '2026年度KPI绩效考核方案',
          template: '年度KPI考核模板_v2.0',
          cycleType: '年度',
          evalMode: 'KPI考核',
          scoreMode: '百分制',
          salaryLink: '绩效工资占比30%',
        ...
        {
          id: 2,
          planName: '销售团队季度OKR考核方案',
          template: 'OKR目标管理模板_v1.5',
          cycleType: '季度',
          evalMode: 'OKR目标管理',
          scoreMode: '等级制(S/A/B/C)',
          salaryLink: '绩效奖金挂钩',
          status: '已启用',
        ...
        },
        {
          id: 3,
          planName: '技术研发月度绩效方案',
          template: '研发岗位KPI模板_v3.1',
          cycleType: '月度',
          evalMode: '360度评估',
          scoreMode: '五分制',
          salaryLink: '绩效工资占比20%',
          status: '草稿',
          createTime: '2026-07-20 10:15:00'
        }
      ],
    }
  },
