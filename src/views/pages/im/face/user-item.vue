    ...
    <div class="app">
      ...
      <div class="app-main">
        <div class="main-top">
          <div>用户表情列表</div>
          <div>
            <button style="background-color: #fff;">+新增敏感词</button>
            <button>🔍</button>
          </div>
          <div>
            <button>⟳</button>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th><div class="th-cell">表情图</div></th>
                <th><div class="th-cell">表情名</div></th>
                <th><div class="th-cell">所属用户</div></th>
                <th><div class="th-cell">尺寸</div></th>
