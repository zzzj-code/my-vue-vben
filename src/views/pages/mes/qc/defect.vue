    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>缺陷编码</span>
            <input type="text" placeholder="请输入缺陷编码" />
          </div>
          <div>
            <span>缺陷描述</span>
            <input type="text" placeholder="请输入缺陷描述" />
          </div>
          <div>
            <button>重置</button>
            <button>搜索</button>
      ...
      <div class="app-main">
        ...
        <div class="main-tab">
          <table>
            <thead>
              <tr>
                <th><div class="th-inner">缺陷编码</div></th>
                <th><div class="th-inner">缺陷描述</div></th>
                <th><div class="th-inner">检测项类型</div></th>
                <th><div class="th-inner">缺陷等级</div></th>
    ...
    return {
      tabValue: [
        ...
        },
        {
          id: 2,
          code: "DEF-002",
          description: "表面划伤（表面有明显划痕）",
          type: "外观缺陷",
          level: "一般",
          remark: "划痕长度≥5mm或深度≥0.1mm",
          createTime: "2024-01-15 14:20",
        },
        {
          id: 3,
          code: "DEF-003",
          description: "毛刺（产品边缘有未去除的毛刺）",
          type: "外观缺陷",
          level: "一般",
          remark: "毛刺高度≥0.2mm",
        ...
        },
        {
          id: 4,
          code: "DEF-004",
          description: "气孔（表面或内部有气孔）",
          type: "内部缺陷",
          level: "严重",
          remark: "气孔直径≥0.5mm或数量≥3个",
          createTime: "2024-02-01 11:00",
        },
        {
          id: 5,
          code: "DEF-005",
          description: "色差（颜色与标准色板偏差）",
          type: "外观缺陷",
          level: "一般",
          remark: "ΔE≥2.0",
        ...
        },
        {
          id: 6,
          code: "DEF-006",
          description: "变形（产品形状变形）",
          type: "尺寸缺陷",
          level: "严重",
          remark: "平面度≥0.3mm或扭曲≥0.5mm",
          createTime: "2024-03-01 08:50",
        },
        {
          id: 7,
          code: "DEF-007",
          description: "缺料（注塑件填充不足）",
          type: "内部缺陷",
          level: "严重",
          remark: "缺料面积≥5mm²",
