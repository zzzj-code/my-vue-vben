    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>单位编码</span>
            <input type="text" placeholder="请输入单位编码" v-model="searchForm.field1" />
          </div>
          <div>
            <span>单位名称</span>
            <input type="text" placeholder="请输入单位名称" v-model="searchForm.field2" />
          </div>
          <div>
      ...
      <div class="app-main">
        ...
        <div class="main-tab">
          <table>
            <thead>
              <tr>
                <th><div class="th-inner">单位编码</div></th>
                <th><div class="th-inner">单位名称</div></th>
                <th><div class="th-inner">是否主单位</div></th>
                <th><div class="th-inner">与主单位换算比例</div></th>
            ...
            <tbody>
              <tr v-for="item in tabValue" :key="item.id">
                ...
                <td>
                  <span
                    :style="{
                      color: item.isMain === '是' ? '#52c41a' : '#8c8c8c'
                    }"
                  >{{ item.isMain }}</span>
                </td>
                <td>{{ item.ratio }}</td>
...
<script>
// ========== 导入计量单位相关API ==========
import { getUnitMeasurePage, deleteUnitMeasure } from '#/api/mes/md/unit-measure';
...
export default {
  ...
  methods: {
    ...
    async loadList() {
      try {
        const data = await getUnitMeasurePage({
