    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>规则编码</span>
            <input type="text" placeholder="请输入规则编码" v-model="searchForm.field1" />
          </div>
          <div>
            <span>规则名称</span>
            <input type="text" placeholder="请输入规则名称" v-model="searchForm.field2" />
          </div>
          <div>
      ...
      <div class="app-main">
        <div class="main-top">
          <div>编码规则列表</div>
          <div>
            <button @click="handleAdd">+新增编码规则</button>
            <button>导出</button>
            <button>🔍</button>
          </div>
          <div>
        ...
        <div class="main-tab">
          <table>
            <thead>
              <tr>
                <th><div class="th-inner">规则编码</div></th>
                <th><div class="th-inner">规则名称</div></th>
                <th><div class="th-inner">规则描述</div></th>
                <th><div class="th-inner">最大长度</div></th>
                <th><div class="th-inner">是否补齐</div></th>
            ...
            <tbody>
              <tr v-for="item in tabValue" :key="item.id">
                ...
                <td>
                  <span
                    :style="{
                      color: item.isPadding === '是' ? '#52c41a' : '#8c8c8c'
                    }"
                  >{{ item.isPadding }}</span>
                </td>
                <td>
...
<script>
// ========== 导入自动编码相关API ==========
import { getAutoCodePage, deleteAutoCode } from '#/api/mes/md/auto-code';
