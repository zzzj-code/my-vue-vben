    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>路线编码</span>
            <input type="text" placeholder="请输入路线编码" v-model="searchForm.field1" />
          </div>
          <div>
            <span>路线名称</span>
            <input type="text" placeholder="请输入路线名称" v-model="searchForm.field2" />
          </div>
          <div>
      ...
      <div class="app-main">
        <div class="main-top">
          <div>工艺路线列表</div>
          <div>
            <button @click="handleAdd">+新增工艺路线</button>
            <button>导出</button>
            <button>🔍</button>
          </div>
          <div>
        ...
        <div class="main-tab">
          <table>
            <thead>
              <tr>
                <th><div class="th-inner">路线编码</div></th>
                <th><div class="th-inner">路线名称</div></th>
                <th><div class="th-inner">路线说明</div></th>
...
<script>
// ========== 导入工艺路线相关API ==========
import { getRoutePage, deleteRoute } from '#/api/mes/pro/route';
