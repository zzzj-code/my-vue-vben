    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>工序编码</span>
            <input type="text" placeholder="请输入工序编码" v-model="searchForm.field1" />
          </div>
          <div>
            <span>工序名称</span>
            <input type="text" placeholder="请输入工序名称" v-model="searchForm.field2" />
          </div>
          <div>
      ...
      <div class="app-main">
        <div class="main-top">
          <div>生产工序列表</div>
          <div>
            <button @click="handleAdd">+新增工序</button>
            <button>导出</button>
            <button>🔍</button>
          </div>
          <div>
        ...
        <div class="main-tab">
          <table>
            <thead>
              <tr>
                <th><div class="th-inner">工序编码</div></th>
...
<script>
// ========== 导入工序管理相关API ==========
import { getProcessPage, deleteProcess } from '#/api/mes/pro/process';
