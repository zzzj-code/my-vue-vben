    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>维修单编码</span>
            <input type="text" placeholder="请输入维修单编码" v-model="searchForm.field1" />
          </div>
          <div>
            <span>维修单名称</span>
            <input type="text" placeholder="请输入维修单名称" v-model="searchForm.field2" />
          </div>
          <div>
      ...
      <div class="app-main">
        <div class="main-top">
          <div>维修工单列表</div>
          <div>
            <button @click="handleAdd">+新增维修工单</button>
            <button>导出</button>
            <button>🔍</button>
          </div>
          <div>
...
<script>
// ========== 导入维修工单相关API ==========
import { getRepairPage, deleteRepair } from '#/api/mes/dv/repair';
