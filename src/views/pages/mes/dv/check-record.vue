    ...
    <div class="app">
      ...
      <div class="app-main">
        <div class="main-top">
          <div>点检记录列表</div>
          <div>
            <button @click="handleAdd">+新增点检记录</button>
            <button>导出</button>
            <button>🔍</button>
          </div>
          <div>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th><div class="th-inner">点检时间</div></th>
                <th><div class="th-inner">点检人</div></th>
...
<script>
// ========== 导入点检记录相关API ==========
import { getCheckRecordPage, deleteCheckRecord } from '#/api/mes/dv/check-record';
