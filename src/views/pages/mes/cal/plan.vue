    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>计划编码</span>
            <input type="text" placeholder="请输入计划编码" v-model="searchForm.field1" />
          </div>
          <div>
            <span>计划名称</span>
            <input type="text" placeholder="请输入计划名称" v-model="searchForm.field2" />
          </div>
          <div>
      ...
      <div class="app-main">
        <div class="main-top">
          <div>排班计划列表</div>
          <div>
            <button @click="handleAdd">+新增排班计划</button>
            <button>导出</button>
            <button>🔍</button>
          </div>
          <div>
        ...
        <div class="main-tab">
          <table>
            <thead>
              <tr>
                <th><div class="th-inner">计划编码</div></th>
                <th><div class="th-inner">计划名称</div></th>
                <th><div class="th-inner">班组类型</div></th>
                <th><div class="th-inner">开始日期</div></th>
                <th><div class="th-inner">结束日期</div></th>
                <th><div class="th-inner">轮班方式</div></th>
                <th><div class="th-inner">倒班方式</div></th>
            ...
            <tbody>
              <tr v-for="item in tabValue" :key="item.id">
                ...
                <td>{{ item.endDate }}</td>
                <td>{{ item.shiftMode }}</td>
                <td>{{ item.rotationMode }}</td>
                <td>
                  <span
                    :style="{
                      display: 'inline-block',
...
<script>
// ========== 导入排班计划相关API ==========
import { getPlanPage, deletePlan } from '#/api/mes/cal/plan';
