    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>类型编码</span>
            <input type="text" placeholder="请输入类型编码" v-model="searchForm.field1" />
          </div>
          <div>
            <span>类型名称</span>
            <input type="text" placeholder="请输入类型名称" v-model="searchForm.field2" />
          </div>
          <div>
      ...
      <div class="app-main">
        <div class="main-top">
          <div>工具类型列表</div>
          <div>
            <button @click="handleAdd">+新增工具类型</button>
            <button>导出</button>
            <button>🔍</button>
          </div>
          <div>
...
<script>
// ========== 导入工装类型相关API ==========
import { getTypePage, deleteType } from '#/api/mes/tm/type';
