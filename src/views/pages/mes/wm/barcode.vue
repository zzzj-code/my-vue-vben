    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>业务类型</span>
            <input type="text" placeholder="请输入业务类型" v-model="searchForm.field1" />
          </div>
          <div>
            <span>业务编码</span>
            <input type="text" placeholder="请输入业务编码" v-model="searchForm.field2" />
          </div>
          <div>
      ...
      <div class="app-main">
        <div class="main-top">
          <div>条码列表</div>
          <div>
            <button @click="handleAdd">+新增条码</button>
            <button>导出</button>
            <button>🔍</button>
          </div>
          <div>
...
<script>
// ========== 导入条码管理相关API ==========
import { getBarcodePage, deleteBarcode } from '#/api/mes/wm/barcode';
