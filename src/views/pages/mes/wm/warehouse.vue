    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>仓库编码</span>
            <input type="text" placeholder="请输入仓库编码" v-model="searchForm.field1" />
          </div>
          <div>
            <span>仓库名称</span>
            <input type="text" placeholder="请输入仓库名称" v-model="searchForm.field2" />
          </div>
          <div>
...
<script>
// ========== 导入仓库管理相关API ==========
import { getWarehousePage, deleteWarehouse } from '#/api/mes/wm/warehouse';
