    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>盘点类型</span>
            <input type="text" placeholder="请输入盘点类型" v-model="searchForm.field1" />
          </div>
          <div>
            <span>任务编码</span>
            <input type="text" placeholder="请输入任务编码" v-model="searchForm.field2" />
          </div>
          <div>
      ...
      <div class="app-main">
        <div class="main-top">
          <div>盘点任务列表</div>
          <div>
            <button @click="handleAdd">+新增盘点任务</button>
            <button>导出</button>
            <button>🔍</button>
          </div>
          <div>
...
<script>
// ========== 导入盘点任务相关API ==========
import { getTaskPage, deleteTask } from '#/api/mes/wm/stock-taking/task';
