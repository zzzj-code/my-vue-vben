          ...
          <table>
            <thead>
              <tr>
                ...
                <th><div class="th-inner">分类编号</div></th>
            ...
            <tbody>
              <tr v-for="item in tabValue" :key="item.categoryCode">
                <td>{{ item.categoryName }}</td>
                <td style="color: #006be6">{{ item.categoryCode }}</td>
                <td>{{ item.sort }}</td>
                <td>
                  <span
                    :style="{
                      ...
                      border: `1px solid ${item.status === '启用' ? '#52c41a' : '#ff4d4f'}`,
                      borderRadius: '12px',
                      fontSize: '12px'
                    }"
                  >{{ item.status }}</span>
