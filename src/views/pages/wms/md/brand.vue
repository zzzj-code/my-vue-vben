    ...
    <div class="app">
      <div class="app-top">
        <div class="top-inp">
          <div>
            <span>品牌编号</span>
            <input type="text" placeholder="请输入品牌编号" />
          </div>
          <div>
            <span>品牌名称</span>
      ...
      <div class="app-main">
        ...
        <div class="main-tab">
          <table>
            <thead>
              <tr>
                <th><div class="th-inner">品牌编号</div></th>
                <th><div class="th-inner">品牌名称</div></th>
                <th><div class="th-inner">创建时间</div></th>
                <th class="ol-col"><div class="th-inner no-border">操作</div></th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="item in tabValue" :key="item.brandCode">
                <td style="color: #006be6">{{ item.brandCode }}</td>
