...
export default {
  data() {
    return {
      tabValue: [
        {
          orderNo: "CK20260801001",
          businessNo: "SO20260801001",
          status: "已完成",
          type: "销售出库",
          warehouse: "北京中心仓",
          totalQty: "1,250",
        ...
        {
          orderNo: "CK20260801002",
          businessNo: "SO20260801002",
          status: "待审核",
          type: "销售出库",
          warehouse: "上海分仓",
          totalQty: "860",
        ...
        {
          orderNo: "CK20260731003",
          businessNo: "SO20260731003",
          status: "进行中",
          type: "退货出库",
          warehouse: "深圳分仓",
          totalQty: "320",
        ...
        {
          orderNo: "CK20260731004",
          businessNo: "SO20260731004",
          status: "已完成",
          type: "调拨出库",
          warehouse: "广州分仓",
          totalQty: "2,100",
        ...
        {
          orderNo: "CK20260730005",
          businessNo: "SO20260730005",
          status: "已驳回",
          type: "销售出库",
          warehouse: "成都分仓",
          totalQty: "150",
        ...
        {
          orderNo: "CK20260730006",
          businessNo: "SO20260730006",
          status: "进行中",
          type: "调拨出库",
          warehouse: "武汉分仓",
          totalQty: "680",
        ...
        {
          orderNo: "CK20260729007",
          businessNo: "SO20260729007",
          status: "已完成",
          type: "退货出库",
          warehouse: "杭州分仓",
          totalQty: "45",
        ...
        {
          orderNo: "CK20260729008",
          businessNo: "SO20260729008",
          status: "待审核",
          type: "调拨出库",
          warehouse: "南京分仓",
          totalQty: "920",
        ...
        {
          orderNo: "CK20260728009",
          businessNo: "SO20260728009",
          status: "已完成",
          type: "销售出库",
          warehouse: "北京中心仓",
          totalQty: "560",
        ...
        {
          orderNo: "CK20260728010",
          businessNo: "SO20260728010",
          status: "待审核",
          type: "调拨出库",
          warehouse: "上海分仓",
          totalQty: "730",
