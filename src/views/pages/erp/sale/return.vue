<template>
  <div class="page-wrapper">
    <div class="app">
      ...
      <div class="app-main">
        <div class="main-top">
          <div class="top-1">销售退货列表</div>
          <div class="top-2">
            <button @click="handleAdd">+新增销售退货</button>
            <button>导出</button>
...
<script>
// ========== 导入销售退货相关API ==========
import { getSaleReturnPage, deleteSaleReturn } from '#/api/erp/sale/return';
...
export default {
  ...
  mounted() {
    this.loadSaleReturnList();
  },
  methods: {
    // ========== 获取销售退货列表 ==========
    async loadSaleReturnList() {
      try {
        const data = await getSaleReturnPage({
